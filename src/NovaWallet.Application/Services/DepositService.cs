...
using NovaWallet.Application.Caching;
...
namespace NovaWallet.Application.Services
{
    public sealed class DepositService : IDepositService
    {
        ...
        private readonly IApplicationDbContext _novaWalletDbContext;
        private readonly HybridCache _hybridCache;
        private readonly NovaWalletMetrics _metrics;
        private readonly IUniqueConstraintViolationDetector _violationDetector;

        public DepositService(
            ILogger<DepositService> logger,
            IApplicationDbContext novaWalletDbContext,
            ...
            CancellationToken cancellationToken)
        {
            ...
            return await strategy.ExecuteAsync(async () =>
            {
                ...
                catch (DbUpdateException ex) when (_violationDetector.IsUniqueViolation(ex))
                {
