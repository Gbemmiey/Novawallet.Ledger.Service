...
namespace NovaWallet.Domain.Entities
{
    ...
    /// <see cref="NovaWallet.Infrastructure.Workers.ReconciliationWorker"/>. Asserts
    ...
    public class LedgerSnapshot
    {
        ...
        /// RunId were computed from the same <see cref="NovaWallet.Infrastructure.Workers.ReconciliationWorker"/>
        /// tick.</summary>
        ...
        /// this snapshot. <see cref="NovaWallet.Infrastructure.Workers.ReconciliationWorker"/> uses this to
